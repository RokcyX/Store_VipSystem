...
@interface SLScanQCodeViewController ()<QRCodeReaderViewDelegate,AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIAlertViewDelegate>
{
...
@implementation SLScanQCodeViewController
...
- (void)alumbBtnEvent
{
    // CIDetectorTracking   CIDetectorAccuracyHigh
    self.detector = [CIDetector detectorOfType:CIDetectorTypeQRCode context:[CIContext contextWithOptions:@{kCIContextUseSoftwareRenderer:@(YES)}] options:@{ CIDetectorAccuracy :  CIDetectorAccuracyHigh}];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    if (features.count > 0) {
        ...
        UIAlertView * alertView = [[UIAlertView alloc]initWithTitle:NSLocalizedString(@"Message", @"") message:NSLocalizedString(@"there is no a QR code in this picture!", @"") delegate:nil cancelButtonTitle:NSLocalizedString(@"Define", @"") otherButtonTitles:nil, nil];
        [alertView show];
