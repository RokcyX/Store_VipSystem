...
typedef NS_ENUM(NSInteger, XYProgressHUDStatus) {
    
    /** 成功 */
    XYProgressHUDStatusSuccess,
    
    /** 失败 */
    XYProgressHUDStatusError,
    
    /** 警告*/
    XYProgressHUDStatusWaitting,
    
    /** 提示 */
    XYProgressHUDStatusInfo,
    
    /** 等待 */
    XYProgressHUDStatusLoading
